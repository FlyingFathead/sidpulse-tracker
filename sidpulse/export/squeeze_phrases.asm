; SQUEEZER v2.0.1 resident phrase-call decoder. One non-recursive call level.
...
; only the original literal/reference packets. A repeated body restarts in place.
phrase_call:
        lda sequence_lo,x
        sta return_lo,x
        lda sequence_hi,x
