...
GUIDE = [
    ...
    ('NOTE KEYS', [
        ('Both NOTE cursor positions', 'Use the complete piano range; Caps Lock previews from any voice field.'),
    ...
    ('MONITOR', [
        ...
        ('Voice waveform displays', 'Each display shows its own native SID voice before the shared filter.'),
    ]),
    ('BLOCKS', [
        ('Alt+B / Alt+E', 'Mark the beginning / End of a block'),
        ('Shift+arrows / Alt+L', 'Extend selection / Select voice or whole pattern'),
        ('Alt+C / Alt+Z', 'Copy / Cut selection'),
        ('Alt+P / Alt+O / Alt+M', 'Insert / Overwrite / Mix paste into empty cells'),
        ...
        ('Ctrl+Insert / Delete', 'Roll the selected block'),
    ...
    ('DISPLAY', [
        ...
        ('preferences.json', 'Edit colours, font and file_browser_show_modified (true/false).'),
    ]),
    ('FILTER ROWS', [
    ...
    ('INSTRUMENTS', [
        ...
        ('General / ADSR', 'Drag envelope handles or sliders. Both update the same saved SID values.'),
    ...
    ('SAMPLES', [
        ...
        ('PCM import / Digi playback', 'Not implemented yet; stored sample data survives project saves.'),
    ]),
    ('AUDIO', [
