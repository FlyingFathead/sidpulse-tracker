...
GUIDE = [
    ...
    ('INSTRUMENTS', [
        ...
        ('Clear all instruments', 'F4 bulk action asks twice, saves a separate project backup, and can be undone.'),
    ...
    ('ORDERS', [
        ...
        ('Pattern bank Rows / triangles', 'Double-click Rows for slider/number; triangles change one row immediately. Populated rows cannot be shortened away.'),
