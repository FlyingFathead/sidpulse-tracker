# SIDpulse Tracker v0.2.28

This build has its own version and filenames to distinguish it from all earlier
v0.2.27 downloads. The version changes application/launcher identification,
native save metadata and squeezed PRG credits. It introduces no additional
playback, recording, compression or UI algorithm changes.
...
See [matched performance measurements](PERFORMANCE-v0.2.28.md), including the
...
See [validation](VALIDATION-v0.2.28.md) and [apply instructions](APPLY-v0.2.28.md).
